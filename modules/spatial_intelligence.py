...
# View fetch radius — mirrors view.py FETCH_RADIUS
_VIEW_FETCH_RADIUS = 500
_VIEW_RADIUS_M     = 200
...
def _fetch_view_features(lon: float, lat: float, radius_m: int) -> dict:
    """
    Fetch OSM features for view classification.
    Returns dict with keys: buildings, parks, water.
...
def _build_noise_grid(
    ...
    Returns (X, Y, noise) or (None, None, None) on failure.
    """
